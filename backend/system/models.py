...
class Menu(CoreModel):
    ...
    from_src = models.CharField(max_length=512, null=True, blank=True, verbose_name="外链地址", help_text="外链地址")
...
class Area(CoreModel):
    ...
    parent = models.ForeignKey(to='self', on_delete=models.PROTECT, default=None, verbose_name="上级地区",
                                db_constraint=False, null=True, blank=True, help_text="上级地区")
