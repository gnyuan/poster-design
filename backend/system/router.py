...
from system.apis.area import router as area_router
from system.apis.whitelist import router as whitelist_router
from system.apis.system_config import router as system_config_router


system_router = Router()
system_router.add_router('/', dept_router, tags=["Dept"])
system_router.add_router('/', post_router, tags=["Post"])
system_router.add_router('/', whitelist_router, tags=["APIWhiteList"])
...
system_router.add_router('/', area_router, tags=["Area"])
system_router.add_router('/', system_config_router, tags=["SystemConfig"])
